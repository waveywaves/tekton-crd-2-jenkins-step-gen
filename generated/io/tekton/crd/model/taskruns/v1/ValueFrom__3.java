...
public class ValueFrom__3 {
    ...
    @Valid
    private ConfigMapKeyRef__3 configMapKeyRef;
    /**
    ...
    @Valid
    private ResourceFieldRef__4 resourceFieldRef;
    /**
    ...
    @Valid
    private SecretKeyRef__3 secretKeyRef;
    @JsonIgnore
    @Valid
     ...
     */
    @JsonProperty("configMapKeyRef")
    public ConfigMapKeyRef__3 getConfigMapKeyRef() {
     ...
     */
    @JsonProperty("configMapKeyRef")
    public void setConfigMapKeyRef(ConfigMapKeyRef__3 configMapKeyRef) {
        this.configMapKeyRef = configMapKeyRef;
    }

    public ValueFrom__3 withConfigMapKeyRef(ConfigMapKeyRef__3 configMapKeyRef) {
        this.configMapKeyRef = configMapKeyRef;
        return this;
    }
     ...
     */
    @JsonProperty("fieldRef")
    public FieldRef__4 getFieldRef() {
        return fieldRef;
    }
     ...
     */
    @JsonProperty("fieldRef")
    public void setFieldRef(FieldRef__4 fieldRef) {
        this.fieldRef = fieldRef;
    }

    public ValueFrom__3 withFieldRef(FieldRef__4 fieldRef) {
        this.fieldRef = fieldRef;
        return this;
    }
     ...
     */
    @JsonProperty("resourceFieldRef")
    public ResourceFieldRef__4 getResourceFieldRef() {
     ...
     */
    @JsonProperty("resourceFieldRef")
    public void setResourceFieldRef(ResourceFieldRef__4 resourceFieldRef) {
        this.resourceFieldRef = resourceFieldRef;
    }

    public ValueFrom__3 withResourceFieldRef(ResourceFieldRef__4 resourceFieldRef) {
        this.resourceFieldRef = resourceFieldRef;
        return this;
    }
     ...
     */
    @JsonProperty("secretKeyRef")
    public SecretKeyRef__3 getSecretKeyRef() {
        return secretKeyRef;
    }
     ...
     */
    @JsonProperty("secretKeyRef")
    public void setSecretKeyRef(SecretKeyRef__3 secretKeyRef) {
        this.secretKeyRef = secretKeyRef;
    }

    public ValueFrom__3 withSecretKeyRef(SecretKeyRef__3 secretKeyRef) {
        this.secretKeyRef = secretKeyRef;
        return this;
    }
    ...
    public ValueFrom__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ValueFrom__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ValueFrom__3) == false) {
            return false;
        }
        ValueFrom__3 rhs = ((ValueFrom__3) other);
