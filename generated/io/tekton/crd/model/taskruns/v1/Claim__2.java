...
public class Claim__2 {
    ...
    public Claim__2 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Claim__2 withRequest(String request) {
        this.request = request;
        return this;
    }
    ...
    public Claim__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Claim__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Claim__2) == false) {
            return false;
        }
        Claim__2 rhs = ((Claim__2) other);
