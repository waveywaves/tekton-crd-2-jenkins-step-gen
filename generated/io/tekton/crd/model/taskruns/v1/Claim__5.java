...
public class Claim__5 {
    ...
    public Claim__5 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Claim__5 withRequest(String request) {
        this.request = request;
        return this;
    }
    ...
    public Claim__5 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Claim__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Claim__5) == false) {
            return false;
        }
        Claim__5 rhs = ((Claim__5) other);
