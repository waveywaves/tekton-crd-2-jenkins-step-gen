...
public class Claim__3 {
    ...
    public Claim__3 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Claim__3 withRequest(String request) {
        this.request = request;
        return this;
    }
    ...
    public Claim__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Claim__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Claim__3) == false) {
            return false;
        }
        Claim__3 rhs = ((Claim__3) other);
