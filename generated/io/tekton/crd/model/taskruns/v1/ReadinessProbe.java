...
public class ReadinessProbe {
    ...
    @Valid
    private TcpSocket__3 tcpSocket;
    /**
     ...
     */
    @JsonProperty("exec")
    public void setExec(Exec__3 exec) {
        this.exec = exec;
    }

    public ReadinessProbe withExec(Exec__3 exec) {
        this.exec = exec;
        return this;
    }
    ...
    public ReadinessProbe withFailureThreshold(Integer failureThreshold) {
        this.failureThreshold = failureThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("grpc")
    public void setGrpc(Grpc__1 grpc) {
        this.grpc = grpc;
    }

    public ReadinessProbe withGrpc(Grpc__1 grpc) {
        this.grpc = grpc;
        return this;
    }
     ...
     */
    @JsonProperty("httpGet")
    public void setHttpGet(HttpGet__3 httpGet) {
        this.httpGet = httpGet;
    }

    public ReadinessProbe withHttpGet(HttpGet__3 httpGet) {
        this.httpGet = httpGet;
        return this;
    }
    ...
    public ReadinessProbe withInitialDelaySeconds(Integer initialDelaySeconds) {
        this.initialDelaySeconds = initialDelaySeconds;
        return this;
    }
    ...
    public ReadinessProbe withPeriodSeconds(Integer periodSeconds) {
        this.periodSeconds = periodSeconds;
        return this;
    }
    ...
    public ReadinessProbe withSuccessThreshold(Integer successThreshold) {
        this.successThreshold = successThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public TcpSocket__3 getTcpSocket() {
        return tcpSocket;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public void setTcpSocket(TcpSocket__3 tcpSocket) {
        this.tcpSocket = tcpSocket;
    }

    public ReadinessProbe withTcpSocket(TcpSocket__3 tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }
    ...
    public ReadinessProbe withTerminationGracePeriodSeconds(Integer terminationGracePeriodSeconds) {
        this.terminationGracePeriodSeconds = terminationGracePeriodSeconds;
        return this;
    }
    ...
    public ReadinessProbe withTimeoutSeconds(Integer timeoutSeconds) {
        this.timeoutSeconds = timeoutSeconds;
        return this;
    }
    ...
    public ReadinessProbe withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ReadinessProbe.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("exec");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReadinessProbe) == false) {
            return false;
        }
        ReadinessProbe rhs = ((ReadinessProbe) other);
