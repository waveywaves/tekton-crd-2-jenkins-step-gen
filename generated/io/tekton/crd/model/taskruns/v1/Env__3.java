...
public class Env__3 {
    ...
    @Valid
    private ValueFrom__3 valueFrom;
    @JsonIgnore
    @Valid
    ...
    public Env__3 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Env__3 withValue(String value) {
        this.value = value;
        return this;
    }
     ...
     */
    @JsonProperty("valueFrom")
    public ValueFrom__3 getValueFrom() {
        return valueFrom;
    }
     ...
     */
    @JsonProperty("valueFrom")
    public void setValueFrom(ValueFrom__3 valueFrom) {
        this.valueFrom = valueFrom;
    }

    public Env__3 withValueFrom(ValueFrom__3 valueFrom) {
        this.valueFrom = valueFrom;
        return this;
    }
    ...
    public Env__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
