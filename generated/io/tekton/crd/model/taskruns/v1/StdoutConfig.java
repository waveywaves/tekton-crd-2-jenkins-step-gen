...
public class StdoutConfig {
    ...
    public StdoutConfig withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public StdoutConfig withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StdoutConfig.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("path");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StdoutConfig) == false) {
            return false;
        }
        StdoutConfig rhs = ((StdoutConfig) other);
