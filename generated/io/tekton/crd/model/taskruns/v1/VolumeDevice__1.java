...
public class VolumeDevice__1 {
    ...
    public VolumeDevice__1 withDevicePath(String devicePath) {
        this.devicePath = devicePath;
        return this;
    }
    ...
    public VolumeDevice__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public VolumeDevice__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(VolumeDevice__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VolumeDevice__1) == false) {
            return false;
        }
        VolumeDevice__1 rhs = ((VolumeDevice__1) other);
