...
public class Running {
    ...
    public Running withStartedAt(Date startedAt) {
        this.startedAt = startedAt;
        return this;
    }
    ...
    public Running withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Running.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("startedAt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Running) == false) {
            return false;
        }
        Running rhs = ((Running) other);
