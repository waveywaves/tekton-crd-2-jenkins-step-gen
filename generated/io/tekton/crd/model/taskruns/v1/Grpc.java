...
public class Grpc {
    ...
    public Grpc withPort(Integer port) {
        this.port = port;
        return this;
    }
    ...
    public Grpc withService(String service) {
        this.service = service;
        return this;
    }
    ...
    public Grpc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Grpc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("port");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Grpc) == false) {
            return false;
        }
        Grpc rhs = ((Grpc) other);
