...
public class Claim__4 {
    ...
    public Claim__4 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Claim__4 withRequest(String request) {
        this.request = request;
        return this;
    }
    ...
    public Claim__4 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Claim__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Claim__4) == false) {
            return false;
        }
        Claim__4 rhs = ((Claim__4) other);
