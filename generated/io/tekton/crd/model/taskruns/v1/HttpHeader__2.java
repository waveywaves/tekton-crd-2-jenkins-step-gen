...
public class HttpHeader__2 {
    ...
    public HttpHeader__2 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__2 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__2) == false) {
            return false;
        }
        HttpHeader__2 rhs = ((HttpHeader__2) other);
