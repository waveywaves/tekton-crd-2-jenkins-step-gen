...
public class Claim__1 {
    ...
    public Claim__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Claim__1 withRequest(String request) {
        this.request = request;
        return this;
    }
    ...
    public Claim__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Claim__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Claim__1) == false) {
            return false;
        }
        Claim__1 rhs = ((Claim__1) other);
