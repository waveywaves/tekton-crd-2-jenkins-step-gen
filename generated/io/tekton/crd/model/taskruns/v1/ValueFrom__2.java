...
public class ValueFrom__2 {
    ...
    @Valid
    private ConfigMapKeyRef__2 configMapKeyRef;
    /**
    ...
    @Valid
    private ResourceFieldRef__3 resourceFieldRef;
    /**
    ...
    @Valid
    private SecretKeyRef__2 secretKeyRef;
    @JsonIgnore
    @Valid
     ...
     */
    @JsonProperty("configMapKeyRef")
    public ConfigMapKeyRef__2 getConfigMapKeyRef() {
     ...
     */
    @JsonProperty("configMapKeyRef")
    public void setConfigMapKeyRef(ConfigMapKeyRef__2 configMapKeyRef) {
        this.configMapKeyRef = configMapKeyRef;
    }

    public ValueFrom__2 withConfigMapKeyRef(ConfigMapKeyRef__2 configMapKeyRef) {
        this.configMapKeyRef = configMapKeyRef;
        return this;
    }
     ...
     */
    @JsonProperty("fieldRef")
    public FieldRef__3 getFieldRef() {
        return fieldRef;
    }
     ...
     */
    @JsonProperty("fieldRef")
    public void setFieldRef(FieldRef__3 fieldRef) {
        this.fieldRef = fieldRef;
    }

    public ValueFrom__2 withFieldRef(FieldRef__3 fieldRef) {
        this.fieldRef = fieldRef;
        return this;
    }
     ...
     */
    @JsonProperty("resourceFieldRef")
    public ResourceFieldRef__3 getResourceFieldRef() {
     ...
     */
    @JsonProperty("resourceFieldRef")
    public void setResourceFieldRef(ResourceFieldRef__3 resourceFieldRef) {
        this.resourceFieldRef = resourceFieldRef;
    }

    public ValueFrom__2 withResourceFieldRef(ResourceFieldRef__3 resourceFieldRef) {
        this.resourceFieldRef = resourceFieldRef;
        return this;
    }
     ...
     */
    @JsonProperty("secretKeyRef")
    public SecretKeyRef__2 getSecretKeyRef() {
        return secretKeyRef;
    }
     ...
     */
    @JsonProperty("secretKeyRef")
    public void setSecretKeyRef(SecretKeyRef__2 secretKeyRef) {
        this.secretKeyRef = secretKeyRef;
    }

    public ValueFrom__2 withSecretKeyRef(SecretKeyRef__2 secretKeyRef) {
        this.secretKeyRef = secretKeyRef;
        return this;
    }
    ...
    public ValueFrom__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ValueFrom__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ValueFrom__2) == false) {
            return false;
        }
        ValueFrom__2 rhs = ((ValueFrom__2) other);
