...
public class RefSource {
    ...
    public RefSource withDigest(Digest__2 digest) {
        this.digest = digest;
        return this;
    }
    ...
    public RefSource withEntryPoint(String entryPoint) {
        this.entryPoint = entryPoint;
        return this;
    }
    ...
    public RefSource withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public RefSource withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RefSource.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("digest");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RefSource) == false) {
            return false;
        }
        RefSource rhs = ((RefSource) other);
