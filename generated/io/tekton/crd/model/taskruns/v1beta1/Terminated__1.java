...
public class Terminated__1 {
    ...
    public Terminated__1 withContainerID(String containerID) {
        this.containerID = containerID;
        return this;
    }
    ...
    public Terminated__1 withExitCode(Integer exitCode) {
        this.exitCode = exitCode;
        return this;
    }
    ...
    public Terminated__1 withFinishedAt(Date finishedAt) {
        this.finishedAt = finishedAt;
        return this;
    }
    ...
    public Terminated__1 withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Terminated__1 withReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public Terminated__1 withSignal(Integer signal) {
        this.signal = signal;
        return this;
    }
    ...
    public Terminated__1 withStartedAt(Date startedAt) {
        this.startedAt = startedAt;
        return this;
    }
    ...
    public Terminated__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Terminated__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Terminated__1) == false) {
            return false;
        }
        Terminated__1 rhs = ((Terminated__1) other);
