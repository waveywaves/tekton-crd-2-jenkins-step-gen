...
public class ResourceRef__1 {
    ...
    public ResourceRef__1 withApiVersion(String apiVersion) {
        this.apiVersion = apiVersion;
        return this;
    }
    ...
    public ResourceRef__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ResourceRef__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ResourceRef__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResourceRef__1) == false) {
            return false;
        }
        ResourceRef__1 rhs = ((ResourceRef__1) other);
