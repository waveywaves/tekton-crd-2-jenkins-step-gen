...
public class ClusterTrustBundle {
    ...
    @Valid
    private LabelSelector__2 labelSelector;
    /**
     ...
     */
    @JsonProperty("labelSelector")
    public LabelSelector__2 getLabelSelector() {
     ...
     */
    @JsonProperty("labelSelector")
    public void setLabelSelector(LabelSelector__2 labelSelector) {
        this.labelSelector = labelSelector;
    }

    public ClusterTrustBundle withLabelSelector(LabelSelector__2 labelSelector) {
        this.labelSelector = labelSelector;
        return this;
    }
