...
public class Env__1 {
    ...
    @Valid
    private ValueFrom__1 valueFrom;
    @JsonIgnore
    @Valid
    ...
    public Env__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Env__1 withValue(String value) {
        this.value = value;
        return this;
    }
     ...
     */
    @JsonProperty("valueFrom")
    public ValueFrom__1 getValueFrom() {
        return valueFrom;
    }
     ...
     */
    @JsonProperty("valueFrom")
    public void setValueFrom(ValueFrom__1 valueFrom) {
        this.valueFrom = valueFrom;
    }

    public Env__1 withValueFrom(ValueFrom__1 valueFrom) {
        this.valueFrom = valueFrom;
        return this;
    }
    ...
    public Env__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
