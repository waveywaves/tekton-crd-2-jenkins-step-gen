...
public class FeatureFlags {
    ...
    public FeatureFlags withAwaitSidecarReadiness(Boolean awaitSidecarReadiness) {
        this.awaitSidecarReadiness = awaitSidecarReadiness;
        return this;
    }
    ...
    public FeatureFlags withCoschedule(String coschedule) {
        this.coschedule = coschedule;
        return this;
    }
    ...
    public FeatureFlags withDisableCredsInit(Boolean disableCredsInit) {
        this.disableCredsInit = disableCredsInit;
        return this;
    }
    ...
    public FeatureFlags withDisableInlineSpec(String disableInlineSpec) {
        this.disableInlineSpec = disableInlineSpec;
        return this;
    }
    ...
    public FeatureFlags withEnableAPIFields(String enableAPIFields) {
        this.enableAPIFields = enableAPIFields;
        return this;
    }
    ...
    public FeatureFlags withEnableArtifacts(Boolean enableArtifacts) {
        this.enableArtifacts = enableArtifacts;
        return this;
    }
    ...
    public FeatureFlags withEnableCELInWhenExpression(Boolean enableCELInWhenExpression) {
        this.enableCELInWhenExpression = enableCELInWhenExpression;
        return this;
    }
    ...
    public FeatureFlags withEnableConciseResolverSyntax(Boolean enableConciseResolverSyntax) {
        this.enableConciseResolverSyntax = enableConciseResolverSyntax;
        return this;
    }
    ...
    public FeatureFlags withEnableKeepPodOnCancel(Boolean enableKeepPodOnCancel) {
        this.enableKeepPodOnCancel = enableKeepPodOnCancel;
        return this;
    }
    ...
    public FeatureFlags withEnableKubernetesSidecar(Boolean enableKubernetesSidecar) {
        this.enableKubernetesSidecar = enableKubernetesSidecar;
        return this;
    }
    ...
    public FeatureFlags withEnableParamEnum(Boolean enableParamEnum) {
        this.enableParamEnum = enableParamEnum;
        return this;
    }
    ...
    public FeatureFlags withEnableProvenanceInStatus(Boolean enableProvenanceInStatus) {
        this.enableProvenanceInStatus = enableProvenanceInStatus;
        return this;
    }
    ...
    public FeatureFlags withEnableStepActions(Boolean enableStepActions) {
        this.enableStepActions = enableStepActions;
        return this;
    }
    ...
    public FeatureFlags withEnforceNonfalsifiability(String enforceNonfalsifiability) {
        this.enforceNonfalsifiability = enforceNonfalsifiability;
        return this;
    }
    ...
    public FeatureFlags withMaxResultSize(Integer maxResultSize) {
        this.maxResultSize = maxResultSize;
        return this;
    }
    ...
    public FeatureFlags withRequireGitSSHSecretKnownHosts(Boolean requireGitSSHSecretKnownHosts) {
        this.requireGitSSHSecretKnownHosts = requireGitSSHSecretKnownHosts;
        return this;
    }
    ...
    public FeatureFlags withResultExtractionMethod(String resultExtractionMethod) {
        this.resultExtractionMethod = resultExtractionMethod;
        return this;
    }
    ...
    public FeatureFlags withRunningInEnvWithInjectedSidecars(Boolean runningInEnvWithInjectedSidecars) {
        this.runningInEnvWithInjectedSidecars = runningInEnvWithInjectedSidecars;
        return this;
    }
    ...
    public FeatureFlags withSendCloudEventsForRuns(Boolean sendCloudEventsForRuns) {
        this.sendCloudEventsForRuns = sendCloudEventsForRuns;
        return this;
    }
    ...
    public FeatureFlags withSetSecurityContext(Boolean setSecurityContext) {
        this.setSecurityContext = setSecurityContext;
        return this;
    }
    ...
    public FeatureFlags withSetSecurityContextReadOnlyRootFilesystem(Boolean setSecurityContextReadOnlyRootFilesystem) {
        this.setSecurityContextReadOnlyRootFilesystem = setSecurityContextReadOnlyRootFilesystem;
        return this;
    }
    ...
    public FeatureFlags withVerificationNoMatchPolicy(String verificationNoMatchPolicy) {
        this.verificationNoMatchPolicy = verificationNoMatchPolicy;
        return this;
    }
    ...
    public FeatureFlags withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FeatureFlags.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FeatureFlags) == false) {
            return false;
        }
        FeatureFlags rhs = ((FeatureFlags) other);
