...
public class Status {
    ...
    @JsonPropertyDescription("PipelineResults are the list of results written out by the pipeline task's containers")
    @Valid
    private List<PipelineResult> pipelineResults = new ArrayList<PipelineResult>();
    /**
     ...
     */
    @JsonProperty("runs")
    @JsonPropertyDescription("Runs is a map of PipelineRunRunStatus with the run name as the key\n\nDeprecated: use ChildReferences instead. As of v0.45.0, this field is no\nlonger populated and is only included for backwards compatibility with\nolder server versions.")
    @Valid
    private Runs runs;
    /**
    ...
    @JsonPropertyDescription("TaskRuns is a map of PipelineRunTaskRunStatus with the taskRun name as the key.\n\nDeprecated: use ChildReferences instead. As of v0.45.0, this field is no\nlonger populated and is only included for backwards compatibility with\nolder server versions.")
    @Valid
     ...
     */
    @JsonProperty("pipelineResults")
    public void setPipelineResults(List<PipelineResult> pipelineResults) {
        this.pipelineResults = pipelineResults;
    }

    public Status withPipelineResults(List<PipelineResult> pipelineResults) {
        this.pipelineResults = pipelineResults;
        return this;
    }
    ...
    public Status withRuns(Runs runs) {
        this.runs = runs;
        return this;
    }
     ...
     */
    @JsonProperty("taskRuns")
    public void setTaskRuns(TaskRuns taskRuns) {
        this.taskRuns = taskRuns;
    }

    public Status withTaskRuns(TaskRuns taskRuns) {
        this.taskRuns = taskRuns;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append('=');
        sb.append(((this.pipelineResults == null)?"<null>":this.pipelineResults));
        sb.append(',');
        ...
        sb.append("taskRuns");
        sb.append('=');
        sb.append(((this.taskRuns == null)?"<null>":this.taskRuns));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.taskRuns == null)? 0 :this.taskRuns.hashCode()));
        result = ((result* 31)+((this.pipelineSpec == null)? 0 :this.pipelineSpec.hashCode()));
        result = ((result* 31)+((this.pipelineResults == null)? 0 :this.pipelineResults.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((this.skippedTasks == rhs.skippedTasks)||((this.skippedTasks!= null)&&this.skippedTasks.equals(rhs.skippedTasks)))&&((this.taskRuns == rhs.taskRuns)||((this.taskRuns!= null)&&this.taskRuns.equals(rhs.taskRuns))))&&((this.pipelineSpec == rhs.pipelineSpec)||((this.pipelineSpec!= null)&&this.pipelineSpec.equals(rhs.pipelineSpec))))&&((this.pipelineResults == rhs.pipelineResults)||((this.pipelineResults!= null)&&this.pipelineResults.equals(rhs.pipelineResults))))&&((this.annotations == rhs.annotations)||((this.annotations!= null)&&this.annotations.equals(rhs.annotations))))&&((this.completionTime == rhs.completionTime)||((this.completionTime!= null)&&this.completionTime.equals(rhs.completionTime))))&&((this.childReferences == rhs.childReferences)||((this.childReferences!= null)&&this.childReferences.equals(rhs.childReferences))))&&((this.provenance == rhs.provenance)||((this.provenance!= null)&&this.provenance.equals(rhs.provenance))))&&((this.finallyStartTime == rhs.finallyStartTime)||((this.finallyStartTime!= null)&&this.finallyStartTime.equals(rhs.finallyStartTime))))&&((this.spanContext == rhs.spanContext)||((this.spanContext!= null)&&this.spanContext.equals(rhs.spanContext))))&&((this.startTime == rhs.startTime)||((this.startTime!= null)&&this.startTime.equals(rhs.startTime))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.conditions == rhs.conditions)||((this.conditions!= null)&&this.conditions.equals(rhs.conditions))))&&((this.runs == rhs.runs)||((this.runs!= null)&&this.runs.equals(rhs.runs))))&&((this.observedGeneration == rhs.observedGeneration)||((this.observedGeneration!= null)&&this.observedGeneration.equals(rhs.observedGeneration))));
    }
