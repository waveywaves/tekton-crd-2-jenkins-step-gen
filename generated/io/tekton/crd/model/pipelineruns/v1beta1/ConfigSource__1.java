...
public class ConfigSource__1 {
     ...
     */
    @JsonProperty("digest")
    public void setDigest(Digest__2 digest) {
        this.digest = digest;
    }

    public ConfigSource__1 withDigest(Digest__2 digest) {
        this.digest = digest;
        return this;
    }
    ...
    public ConfigSource__1 withEntryPoint(String entryPoint) {
        this.entryPoint = entryPoint;
        return this;
    }
    ...
    public ConfigSource__1 withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public ConfigSource__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ConfigSource__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("digest");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConfigSource__1) == false) {
            return false;
        }
        ConfigSource__1 rhs = ((ConfigSource__1) other);
