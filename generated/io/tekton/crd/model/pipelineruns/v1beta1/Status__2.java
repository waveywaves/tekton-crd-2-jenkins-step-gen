...
public class Status__2 {
    ...
    @Valid
    private Annotations__3 annotations;
    /**
    ...
    @Valid
    private List<Condition__2> conditions = new ArrayList<Condition__2>();
    /**
    ...
    @Valid
    private SpanContext__1 spanContext;
    /**
     ...
     */
    @JsonProperty("annotations")
    public Annotations__3 getAnnotations() {
        return annotations;
    }
     ...
     */
    @JsonProperty("annotations")
    public void setAnnotations(Annotations__3 annotations) {
        this.annotations = annotations;
    }

    public Status__2 withAnnotations(Annotations__3 annotations) {
        this.annotations = annotations;
        return this;
    }
    ...
    public Status__2 withCloudEvents(List<CloudEvent> cloudEvents) {
        this.cloudEvents = cloudEvents;
        return this;
    }
    ...
    public Status__2 withCompletionTime(Date completionTime) {
        this.completionTime = completionTime;
        return this;
    }
     ...
     */
    @JsonProperty("conditions")
    public List<Condition__2> getConditions() {
        return conditions;
    }
     ...
     */
    @JsonProperty("conditions")
    public void setConditions(List<Condition__2> conditions) {
        this.conditions = conditions;
    }

    public Status__2 withConditions(List<Condition__2> conditions) {
        this.conditions = conditions;
        return this;
    }
    ...
    public Status__2 withObservedGeneration(Integer observedGeneration) {
        this.observedGeneration = observedGeneration;
        return this;
    }
    ...
    public Status__2 withPodName(String podName) {
        this.podName = podName;
        return this;
    }
    ...
    public Status__2 withProvenance(Provenance__1 provenance) {
        this.provenance = provenance;
        return this;
    }
    ...
    public Status__2 withResourcesResult(List<ResourcesResult> resourcesResult) {
        this.resourcesResult = resourcesResult;
        return this;
    }
    ...
    public Status__2 withRetriesStatus(Object retriesStatus) {
        this.retriesStatus = retriesStatus;
        return this;
    }
    ...
    public Status__2 withSidecars(List<Sidecar> sidecars) {
        this.sidecars = sidecars;
        return this;
    }
     ...
     */
    @JsonProperty("spanContext")
    public SpanContext__1 getSpanContext() {
        return spanContext;
    }
     ...
     */
    @JsonProperty("spanContext")
    public void setSpanContext(SpanContext__1 spanContext) {
        this.spanContext = spanContext;
    }

    public Status__2 withSpanContext(SpanContext__1 spanContext) {
        this.spanContext = spanContext;
        return this;
    }
    ...
    public Status__2 withStartTime(Date startTime) {
        this.startTime = startTime;
        return this;
    }
    ...
    public Status__2 withSteps(List<Step> steps) {
        this.steps = steps;
        return this;
    }
    ...
    public Status__2 withTaskResults(List<TaskResult> taskResults) {
        this.taskResults = taskResults;
        return this;
    }
    ...
    public Status__2 withTaskSpec(Object taskSpec) {
        this.taskSpec = taskSpec;
        return this;
    }
    ...
    public Status__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Status__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Status__2) == false) {
            return false;
        }
        Status__2 rhs = ((Status__2) other);
