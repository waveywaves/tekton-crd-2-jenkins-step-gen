...
public class Waiting {
    ...
    public Waiting withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Waiting withReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public Waiting withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Waiting.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("message");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Waiting) == false) {
            return false;
        }
        Waiting rhs = ((Waiting) other);
