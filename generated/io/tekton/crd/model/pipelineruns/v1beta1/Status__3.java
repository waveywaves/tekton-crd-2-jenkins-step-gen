...
public class Status__3 {
    ...
    public Status__3 withCondition(String condition) {
        this.condition = condition;
        return this;
    }
    ...
    public Status__3 withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Status__3 withRetryCount(Integer retryCount) {
        this.retryCount = retryCount;
        return this;
    }
    ...
    public Status__3 withSentAt(Date sentAt) {
        this.sentAt = sentAt;
        return this;
    }
    ...
    public Status__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Status__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("condition");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Status__3) == false) {
            return false;
        }
        Status__3 rhs = ((Status__3) other);
