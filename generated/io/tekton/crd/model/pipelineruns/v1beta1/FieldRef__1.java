...
public class FieldRef__1 {
    ...
    public FieldRef__1 withApiVersion(String apiVersion) {
        this.apiVersion = apiVersion;
        return this;
    }
    ...
    public FieldRef__1 withFieldPath(String fieldPath) {
        this.fieldPath = fieldPath;
        return this;
    }
    ...
    public FieldRef__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FieldRef__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FieldRef__1) == false) {
            return false;
        }
        FieldRef__1 rhs = ((FieldRef__1) other);
