...
public class Condition__1 {
    ...
    public Condition__1 withLastTransitionTime(String lastTransitionTime) {
        this.lastTransitionTime = lastTransitionTime;
        return this;
    }
    ...
    public Condition__1 withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Condition__1 withReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public Condition__1 withSeverity(String severity) {
        this.severity = severity;
        return this;
    }
    ...
    public Condition__1 withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public Condition__1 withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Condition__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Condition__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Condition__1) == false) {
            return false;
        }
        Condition__1 rhs = ((Condition__1) other);
