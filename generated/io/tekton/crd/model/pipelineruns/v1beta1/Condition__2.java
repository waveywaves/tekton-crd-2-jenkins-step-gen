...
public class Condition__2 {
    ...
    public Condition__2 withLastTransitionTime(String lastTransitionTime) {
        this.lastTransitionTime = lastTransitionTime;
        return this;
    }
    ...
    public Condition__2 withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Condition__2 withReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public Condition__2 withSeverity(String severity) {
        this.severity = severity;
        return this;
    }
    ...
    public Condition__2 withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public Condition__2 withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Condition__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Condition__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
