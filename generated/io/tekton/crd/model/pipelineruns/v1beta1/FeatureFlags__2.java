...
public class FeatureFlags__2 {
    ...
    public FeatureFlags__2 withAwaitSidecarReadiness(Boolean awaitSidecarReadiness) {
        this.awaitSidecarReadiness = awaitSidecarReadiness;
        return this;
    }
    ...
    public FeatureFlags__2 withCoschedule(String coschedule) {
        this.coschedule = coschedule;
        return this;
    }
    ...
    public FeatureFlags__2 withDisableCredsInit(Boolean disableCredsInit) {
        this.disableCredsInit = disableCredsInit;
        return this;
    }
    ...
    public FeatureFlags__2 withDisableInlineSpec(String disableInlineSpec) {
        this.disableInlineSpec = disableInlineSpec;
        return this;
    }
    ...
    public FeatureFlags__2 withEnableAPIFields(String enableAPIFields) {
        this.enableAPIFields = enableAPIFields;
        return this;
    }
    ...
    public FeatureFlags__2 withEnableArtifacts(Boolean enableArtifacts) {
        this.enableArtifacts = enableArtifacts;
        return this;
    }
    ...
    public FeatureFlags__2 withEnableCELInWhenExpression(Boolean enableCELInWhenExpression) {
        this.enableCELInWhenExpression = enableCELInWhenExpression;
        return this;
    }
    ...
    public FeatureFlags__2 withEnableConciseResolverSyntax(Boolean enableConciseResolverSyntax) {
        this.enableConciseResolverSyntax = enableConciseResolverSyntax;
        return this;
    }
    ...
    public FeatureFlags__2 withEnableKeepPodOnCancel(Boolean enableKeepPodOnCancel) {
        this.enableKeepPodOnCancel = enableKeepPodOnCancel;
        return this;
    }
    ...
    public FeatureFlags__2 withEnableKubernetesSidecar(Boolean enableKubernetesSidecar) {
        this.enableKubernetesSidecar = enableKubernetesSidecar;
        return this;
    }
    ...
    public FeatureFlags__2 withEnableParamEnum(Boolean enableParamEnum) {
        this.enableParamEnum = enableParamEnum;
        return this;
    }
    ...
    public FeatureFlags__2 withEnableProvenanceInStatus(Boolean enableProvenanceInStatus) {
        this.enableProvenanceInStatus = enableProvenanceInStatus;
        return this;
    }
    ...
    public FeatureFlags__2 withEnableStepActions(Boolean enableStepActions) {
        this.enableStepActions = enableStepActions;
        return this;
    }
    ...
    public FeatureFlags__2 withEnforceNonfalsifiability(String enforceNonfalsifiability) {
        this.enforceNonfalsifiability = enforceNonfalsifiability;
        return this;
    }
    ...
    public FeatureFlags__2 withMaxResultSize(Integer maxResultSize) {
        this.maxResultSize = maxResultSize;
        return this;
    }
    ...
    public FeatureFlags__2 withRequireGitSSHSecretKnownHosts(Boolean requireGitSSHSecretKnownHosts) {
        this.requireGitSSHSecretKnownHosts = requireGitSSHSecretKnownHosts;
        return this;
    }
    ...
    public FeatureFlags__2 withResultExtractionMethod(String resultExtractionMethod) {
        this.resultExtractionMethod = resultExtractionMethod;
        return this;
    }
    ...
    public FeatureFlags__2 withRunningInEnvWithInjectedSidecars(Boolean runningInEnvWithInjectedSidecars) {
        this.runningInEnvWithInjectedSidecars = runningInEnvWithInjectedSidecars;
        return this;
    }
    ...
    public FeatureFlags__2 withSendCloudEventsForRuns(Boolean sendCloudEventsForRuns) {
        this.sendCloudEventsForRuns = sendCloudEventsForRuns;
        return this;
    }
    ...
    public FeatureFlags__2 withSetSecurityContext(Boolean setSecurityContext) {
        this.setSecurityContext = setSecurityContext;
        return this;
    }
    ...
    public FeatureFlags__2 withSetSecurityContextReadOnlyRootFilesystem(Boolean setSecurityContextReadOnlyRootFilesystem) {
        this.setSecurityContextReadOnlyRootFilesystem = setSecurityContextReadOnlyRootFilesystem;
        return this;
    }
    ...
    public FeatureFlags__2 withVerificationNoMatchPolicy(String verificationNoMatchPolicy) {
        this.verificationNoMatchPolicy = verificationNoMatchPolicy;
        return this;
    }
    ...
    public FeatureFlags__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FeatureFlags__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FeatureFlags__2) == false) {
            return false;
        }
        FeatureFlags__2 rhs = ((FeatureFlags__2) other);
