...
public class ConfigSource__2 {
     ...
     */
    @JsonProperty("digest")
    public void setDigest(Digest__6 digest) {
        this.digest = digest;
    }

    public ConfigSource__2 withDigest(Digest__6 digest) {
        this.digest = digest;
        return this;
    }
    ...
    public ConfigSource__2 withEntryPoint(String entryPoint) {
        this.entryPoint = entryPoint;
        return this;
    }
    ...
    public ConfigSource__2 withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public ConfigSource__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ConfigSource__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("digest");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConfigSource__2) == false) {
            return false;
        }
        ConfigSource__2 rhs = ((ConfigSource__2) other);
