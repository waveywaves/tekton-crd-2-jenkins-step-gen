...
public class RefSource__2 {
     ...
     */
    @JsonProperty("digest")
    public void setDigest(Digest__7 digest) {
        this.digest = digest;
    }

    public RefSource__2 withDigest(Digest__7 digest) {
        this.digest = digest;
        return this;
    }
    ...
    public RefSource__2 withEntryPoint(String entryPoint) {
        this.entryPoint = entryPoint;
        return this;
    }
    ...
    public RefSource__2 withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public RefSource__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RefSource__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("digest");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RefSource__2) == false) {
            return false;
        }
        RefSource__2 rhs = ((RefSource__2) other);
