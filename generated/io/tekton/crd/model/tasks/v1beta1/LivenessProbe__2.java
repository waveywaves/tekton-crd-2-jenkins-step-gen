...
public class LivenessProbe__2 {
    ...
    @Valid
    private TcpSocket__12 tcpSocket;
    /**
     ...
     */
    @JsonProperty("exec")
    public void setExec(Exec__12 exec) {
        this.exec = exec;
    }

    public LivenessProbe__2 withExec(Exec__12 exec) {
        this.exec = exec;
        return this;
    }
    ...
    public LivenessProbe__2 withFailureThreshold(Integer failureThreshold) {
        this.failureThreshold = failureThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("grpc")
    public void setGrpc(Grpc__6 grpc) {
        this.grpc = grpc;
    }

    public LivenessProbe__2 withGrpc(Grpc__6 grpc) {
        this.grpc = grpc;
        return this;
    }
     ...
     */
    @JsonProperty("httpGet")
    public void setHttpGet(HttpGet__12 httpGet) {
        this.httpGet = httpGet;
    }

    public LivenessProbe__2 withHttpGet(HttpGet__12 httpGet) {
        this.httpGet = httpGet;
        return this;
    }
    ...
    public LivenessProbe__2 withInitialDelaySeconds(Integer initialDelaySeconds) {
        this.initialDelaySeconds = initialDelaySeconds;
        return this;
    }
    ...
    public LivenessProbe__2 withPeriodSeconds(Integer periodSeconds) {
        this.periodSeconds = periodSeconds;
        return this;
    }
    ...
    public LivenessProbe__2 withSuccessThreshold(Integer successThreshold) {
        this.successThreshold = successThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public TcpSocket__12 getTcpSocket() {
        return tcpSocket;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public void setTcpSocket(TcpSocket__12 tcpSocket) {
        this.tcpSocket = tcpSocket;
    }

    public LivenessProbe__2 withTcpSocket(TcpSocket__12 tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }
    ...
    public LivenessProbe__2 withTerminationGracePeriodSeconds(Integer terminationGracePeriodSeconds) {
        this.terminationGracePeriodSeconds = terminationGracePeriodSeconds;
        return this;
    }
    ...
    public LivenessProbe__2 withTimeoutSeconds(Integer timeoutSeconds) {
        this.timeoutSeconds = timeoutSeconds;
        return this;
    }
    ...
    public LivenessProbe__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LivenessProbe__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("exec");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LivenessProbe__2) == false) {
            return false;
        }
        LivenessProbe__2 rhs = ((LivenessProbe__2) other);
