...
public class ReadinessProbe__2 {
    ...
    @Valid
    private TcpSocket__13 tcpSocket;
    /**
     ...
     */
    @JsonProperty("exec")
    public void setExec(Exec__13 exec) {
        this.exec = exec;
    }

    public ReadinessProbe__2 withExec(Exec__13 exec) {
        this.exec = exec;
        return this;
    }
    ...
    public ReadinessProbe__2 withFailureThreshold(Integer failureThreshold) {
        this.failureThreshold = failureThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("grpc")
    public void setGrpc(Grpc__7 grpc) {
        this.grpc = grpc;
    }

    public ReadinessProbe__2 withGrpc(Grpc__7 grpc) {
        this.grpc = grpc;
        return this;
    }
     ...
     */
    @JsonProperty("httpGet")
    public void setHttpGet(HttpGet__13 httpGet) {
        this.httpGet = httpGet;
    }

    public ReadinessProbe__2 withHttpGet(HttpGet__13 httpGet) {
        this.httpGet = httpGet;
        return this;
    }
    ...
    public ReadinessProbe__2 withInitialDelaySeconds(Integer initialDelaySeconds) {
        this.initialDelaySeconds = initialDelaySeconds;
        return this;
    }
    ...
    public ReadinessProbe__2 withPeriodSeconds(Integer periodSeconds) {
        this.periodSeconds = periodSeconds;
        return this;
    }
    ...
    public ReadinessProbe__2 withSuccessThreshold(Integer successThreshold) {
        this.successThreshold = successThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public TcpSocket__13 getTcpSocket() {
        return tcpSocket;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public void setTcpSocket(TcpSocket__13 tcpSocket) {
        this.tcpSocket = tcpSocket;
    }

    public ReadinessProbe__2 withTcpSocket(TcpSocket__13 tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }
    ...
    public ReadinessProbe__2 withTerminationGracePeriodSeconds(Integer terminationGracePeriodSeconds) {
        this.terminationGracePeriodSeconds = terminationGracePeriodSeconds;
        return this;
    }
    ...
    public ReadinessProbe__2 withTimeoutSeconds(Integer timeoutSeconds) {
        this.timeoutSeconds = timeoutSeconds;
        return this;
    }
    ...
    public ReadinessProbe__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ReadinessProbe__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("exec");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReadinessProbe__2) == false) {
            return false;
        }
        ReadinessProbe__2 rhs = ((ReadinessProbe__2) other);
