...
public class Lifecycle__2 {
    ...
    @Valid
    private PostStart__2 postStart;
    /**
     ...
     */
    @JsonProperty("postStart")
    public PostStart__2 getPostStart() {
        return postStart;
    }
     ...
     */
    @JsonProperty("postStart")
    public void setPostStart(PostStart__2 postStart) {
        this.postStart = postStart;
    }

    public Lifecycle__2 withPostStart(PostStart__2 postStart) {
        this.postStart = postStart;
        return this;
    }
     ...
     */
    @JsonProperty("preStop")
    public void setPreStop(PreStop__2 preStop) {
        this.preStop = preStop;
    }

    public Lifecycle__2 withPreStop(PreStop__2 preStop) {
        this.preStop = preStop;
        return this;
    }
    ...
    public Lifecycle__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Lifecycle__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("postStart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Lifecycle__2) == false) {
            return false;
        }
        Lifecycle__2 rhs = ((Lifecycle__2) other);
