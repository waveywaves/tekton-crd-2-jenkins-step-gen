...
public class HttpHeader__14 {
    ...
    public HttpHeader__14 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__14 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__14 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__14 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__14) == false) {
            return false;
        }
        HttpHeader__14 rhs = ((HttpHeader__14) other);
