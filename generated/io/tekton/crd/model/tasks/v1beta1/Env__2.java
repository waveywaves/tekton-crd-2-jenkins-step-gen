...
public class Env__2 {
    ...
    @Valid
    private ValueFrom__2 valueFrom;
    @JsonIgnore
    @Valid
    ...
    public Env__2 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Env__2 withValue(String value) {
        this.value = value;
        return this;
    }
     ...
     */
    @JsonProperty("valueFrom")
    public ValueFrom__2 getValueFrom() {
        return valueFrom;
    }
     ...
     */
    @JsonProperty("valueFrom")
    public void setValueFrom(ValueFrom__2 valueFrom) {
        this.valueFrom = valueFrom;
    }

    public Env__2 withValueFrom(ValueFrom__2 valueFrom) {
        this.valueFrom = valueFrom;
        return this;
    }
    ...
    public Env__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
