...
public class HttpHeader__7 {
    ...
    public HttpHeader__7 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__7 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__7 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__7) == false) {
            return false;
        }
        HttpHeader__7 rhs = ((HttpHeader__7) other);
