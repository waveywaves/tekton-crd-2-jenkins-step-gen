...
public class Lifecycle__1 {
    ...
    @Valid
    private PostStart__1 postStart;
    /**
     ...
     */
    @JsonProperty("postStart")
    public PostStart__1 getPostStart() {
        return postStart;
    }
     ...
     */
    @JsonProperty("postStart")
    public void setPostStart(PostStart__1 postStart) {
        this.postStart = postStart;
    }

    public Lifecycle__1 withPostStart(PostStart__1 postStart) {
        this.postStart = postStart;
        return this;
    }
     ...
     */
    @JsonProperty("preStop")
    public void setPreStop(PreStop__1 preStop) {
        this.preStop = preStop;
    }

    public Lifecycle__1 withPreStop(PreStop__1 preStop) {
        this.preStop = preStop;
        return this;
    }
    ...
    public Lifecycle__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Lifecycle__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("postStart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Lifecycle__1) == false) {
            return false;
        }
        Lifecycle__1 rhs = ((Lifecycle__1) other);
