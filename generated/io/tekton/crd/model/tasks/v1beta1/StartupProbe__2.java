...
public class StartupProbe__2 {
    ...
    @Valid
    private TcpSocket__14 tcpSocket;
    /**
     ...
     */
    @JsonProperty("exec")
    public void setExec(Exec__14 exec) {
        this.exec = exec;
    }

    public StartupProbe__2 withExec(Exec__14 exec) {
        this.exec = exec;
        return this;
    }
    ...
    public StartupProbe__2 withFailureThreshold(Integer failureThreshold) {
        this.failureThreshold = failureThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("grpc")
    public void setGrpc(Grpc__8 grpc) {
        this.grpc = grpc;
    }

    public StartupProbe__2 withGrpc(Grpc__8 grpc) {
        this.grpc = grpc;
        return this;
    }
     ...
     */
    @JsonProperty("httpGet")
    public void setHttpGet(HttpGet__14 httpGet) {
        this.httpGet = httpGet;
    }

    public StartupProbe__2 withHttpGet(HttpGet__14 httpGet) {
        this.httpGet = httpGet;
        return this;
    }
    ...
    public StartupProbe__2 withInitialDelaySeconds(Integer initialDelaySeconds) {
        this.initialDelaySeconds = initialDelaySeconds;
        return this;
    }
    ...
    public StartupProbe__2 withPeriodSeconds(Integer periodSeconds) {
        this.periodSeconds = periodSeconds;
        return this;
    }
    ...
    public StartupProbe__2 withSuccessThreshold(Integer successThreshold) {
        this.successThreshold = successThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public TcpSocket__14 getTcpSocket() {
        return tcpSocket;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public void setTcpSocket(TcpSocket__14 tcpSocket) {
        this.tcpSocket = tcpSocket;
    }

    public StartupProbe__2 withTcpSocket(TcpSocket__14 tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }
    ...
    public StartupProbe__2 withTerminationGracePeriodSeconds(Integer terminationGracePeriodSeconds) {
        this.terminationGracePeriodSeconds = terminationGracePeriodSeconds;
        return this;
    }
    ...
    public StartupProbe__2 withTimeoutSeconds(Integer timeoutSeconds) {
        this.timeoutSeconds = timeoutSeconds;
        return this;
    }
    ...
    public StartupProbe__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StartupProbe__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("exec");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StartupProbe__2) == false) {
            return false;
        }
        StartupProbe__2 rhs = ((StartupProbe__2) other);
