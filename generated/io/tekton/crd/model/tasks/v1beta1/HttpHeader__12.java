...
public class HttpHeader__12 {
    ...
    public HttpHeader__12 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__12 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__12 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__12 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__12) == false) {
            return false;
        }
        HttpHeader__12 rhs = ((HttpHeader__12) other);
