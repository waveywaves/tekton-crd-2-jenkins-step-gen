...
public class HttpHeader__10 {
    ...
    public HttpHeader__10 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__10 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__10 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__10 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__10) == false) {
            return false;
        }
        HttpHeader__10 rhs = ((HttpHeader__10) other);
