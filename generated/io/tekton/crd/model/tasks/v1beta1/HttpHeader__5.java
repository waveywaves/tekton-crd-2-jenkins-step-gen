...
public class HttpHeader__5 {
    ...
    public HttpHeader__5 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__5 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__5 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__5) == false) {
            return false;
        }
        HttpHeader__5 rhs = ((HttpHeader__5) other);
