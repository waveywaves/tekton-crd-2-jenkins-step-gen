...
public class HttpHeader__11 {
    ...
    public HttpHeader__11 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__11 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__11 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__11 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__11) == false) {
            return false;
        }
        HttpHeader__11 rhs = ((HttpHeader__11) other);
