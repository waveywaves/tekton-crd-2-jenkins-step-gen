...
public class PostStart__2 {
    ...
    @Valid
    private TcpSocket__10 tcpSocket;
    @JsonIgnore
    @Valid
     ...
     */
    @JsonProperty("exec")
    public void setExec(Exec__10 exec) {
        this.exec = exec;
    }

    public PostStart__2 withExec(Exec__10 exec) {
        this.exec = exec;
        return this;
    }
     ...
     */
    @JsonProperty("httpGet")
    public void setHttpGet(HttpGet__10 httpGet) {
        this.httpGet = httpGet;
    }

    public PostStart__2 withHttpGet(HttpGet__10 httpGet) {
        this.httpGet = httpGet;
        return this;
    }
     ...
     */
    @JsonProperty("sleep")
    public void setSleep(Sleep__4 sleep) {
        this.sleep = sleep;
    }

    public PostStart__2 withSleep(Sleep__4 sleep) {
        this.sleep = sleep;
        return this;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public TcpSocket__10 getTcpSocket() {
        return tcpSocket;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public void setTcpSocket(TcpSocket__10 tcpSocket) {
        this.tcpSocket = tcpSocket;
    }

    public PostStart__2 withTcpSocket(TcpSocket__10 tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }
    ...
    public PostStart__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PostStart__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("exec");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PostStart__2) == false) {
            return false;
        }
        PostStart__2 rhs = ((PostStart__2) other);
