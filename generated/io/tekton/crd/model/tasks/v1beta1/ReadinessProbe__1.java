...
public class ReadinessProbe__1 {
    ...
    @Valid
    private TcpSocket__8 tcpSocket;
    /**
     ...
     */
    @JsonProperty("exec")
    public void setExec(Exec__8 exec) {
        this.exec = exec;
    }

    public ReadinessProbe__1 withExec(Exec__8 exec) {
        this.exec = exec;
        return this;
    }
    ...
    public ReadinessProbe__1 withFailureThreshold(Integer failureThreshold) {
        this.failureThreshold = failureThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("grpc")
    public void setGrpc(Grpc__4 grpc) {
        this.grpc = grpc;
    }

    public ReadinessProbe__1 withGrpc(Grpc__4 grpc) {
        this.grpc = grpc;
        return this;
    }
     ...
     */
    @JsonProperty("httpGet")
    public void setHttpGet(HttpGet__8 httpGet) {
        this.httpGet = httpGet;
    }

    public ReadinessProbe__1 withHttpGet(HttpGet__8 httpGet) {
        this.httpGet = httpGet;
        return this;
    }
    ...
    public ReadinessProbe__1 withInitialDelaySeconds(Integer initialDelaySeconds) {
        this.initialDelaySeconds = initialDelaySeconds;
        return this;
    }
    ...
    public ReadinessProbe__1 withPeriodSeconds(Integer periodSeconds) {
        this.periodSeconds = periodSeconds;
        return this;
    }
    ...
    public ReadinessProbe__1 withSuccessThreshold(Integer successThreshold) {
        this.successThreshold = successThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public TcpSocket__8 getTcpSocket() {
        return tcpSocket;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public void setTcpSocket(TcpSocket__8 tcpSocket) {
        this.tcpSocket = tcpSocket;
    }

    public ReadinessProbe__1 withTcpSocket(TcpSocket__8 tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }
    ...
    public ReadinessProbe__1 withTerminationGracePeriodSeconds(Integer terminationGracePeriodSeconds) {
        this.terminationGracePeriodSeconds = terminationGracePeriodSeconds;
        return this;
    }
    ...
    public ReadinessProbe__1 withTimeoutSeconds(Integer timeoutSeconds) {
        this.timeoutSeconds = timeoutSeconds;
        return this;
    }
    ...
    public ReadinessProbe__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ReadinessProbe__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("exec");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReadinessProbe__1) == false) {
            return false;
        }
        ReadinessProbe__1 rhs = ((ReadinessProbe__1) other);
