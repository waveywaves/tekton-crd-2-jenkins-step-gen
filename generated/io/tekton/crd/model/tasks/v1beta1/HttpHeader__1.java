...
public class HttpHeader__1 {
    ...
    public HttpHeader__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__1 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__1) == false) {
            return false;
        }
        HttpHeader__1 rhs = ((HttpHeader__1) other);
