...
public class HttpHeader__6 {
    ...
    public HttpHeader__6 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__6 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__6 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__6) == false) {
            return false;
        }
        HttpHeader__6 rhs = ((HttpHeader__6) other);
