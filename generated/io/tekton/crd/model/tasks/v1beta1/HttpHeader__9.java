...
public class HttpHeader__9 {
    ...
    public HttpHeader__9 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__9 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__9 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__9 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__9) == false) {
            return false;
        }
        HttpHeader__9 rhs = ((HttpHeader__9) other);
