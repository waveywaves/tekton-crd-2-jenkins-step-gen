...
public class Port__1 {
    ...
    public Port__1 withContainerPort(Integer containerPort) {
        this.containerPort = containerPort;
        return this;
    }
    ...
    public Port__1 withHostIP(String hostIP) {
        this.hostIP = hostIP;
        return this;
    }
    ...
    public Port__1 withHostPort(Integer hostPort) {
        this.hostPort = hostPort;
        return this;
    }
    ...
    public Port__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Port__1 withProtocol(String protocol) {
        this.protocol = protocol;
        return this;
    }
    ...
    public Port__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Port__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Port__1) == false) {
            return false;
        }
        Port__1 rhs = ((Port__1) other);
