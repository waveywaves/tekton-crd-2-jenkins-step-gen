...
public class LivenessProbe__1 {
    ...
    @Valid
    private TcpSocket__7 tcpSocket;
    /**
     ...
     */
    @JsonProperty("exec")
    public void setExec(Exec__7 exec) {
        this.exec = exec;
    }

    public LivenessProbe__1 withExec(Exec__7 exec) {
        this.exec = exec;
        return this;
    }
    ...
    public LivenessProbe__1 withFailureThreshold(Integer failureThreshold) {
        this.failureThreshold = failureThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("grpc")
    public void setGrpc(Grpc__3 grpc) {
        this.grpc = grpc;
    }

    public LivenessProbe__1 withGrpc(Grpc__3 grpc) {
        this.grpc = grpc;
        return this;
    }
     ...
     */
    @JsonProperty("httpGet")
    public void setHttpGet(HttpGet__7 httpGet) {
        this.httpGet = httpGet;
    }

    public LivenessProbe__1 withHttpGet(HttpGet__7 httpGet) {
        this.httpGet = httpGet;
        return this;
    }
    ...
    public LivenessProbe__1 withInitialDelaySeconds(Integer initialDelaySeconds) {
        this.initialDelaySeconds = initialDelaySeconds;
        return this;
    }
    ...
    public LivenessProbe__1 withPeriodSeconds(Integer periodSeconds) {
        this.periodSeconds = periodSeconds;
        return this;
    }
    ...
    public LivenessProbe__1 withSuccessThreshold(Integer successThreshold) {
        this.successThreshold = successThreshold;
        return this;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public TcpSocket__7 getTcpSocket() {
        return tcpSocket;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public void setTcpSocket(TcpSocket__7 tcpSocket) {
        this.tcpSocket = tcpSocket;
    }

    public LivenessProbe__1 withTcpSocket(TcpSocket__7 tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }
    ...
    public LivenessProbe__1 withTerminationGracePeriodSeconds(Integer terminationGracePeriodSeconds) {
        this.terminationGracePeriodSeconds = terminationGracePeriodSeconds;
        return this;
    }
    ...
    public LivenessProbe__1 withTimeoutSeconds(Integer timeoutSeconds) {
        this.timeoutSeconds = timeoutSeconds;
        return this;
    }
    ...
    public LivenessProbe__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LivenessProbe__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("exec");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LivenessProbe__1) == false) {
            return false;
        }
        LivenessProbe__1 rhs = ((LivenessProbe__1) other);
