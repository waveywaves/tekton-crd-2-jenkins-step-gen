...
public class Port__2 {
    ...
    public Port__2 withContainerPort(Integer containerPort) {
        this.containerPort = containerPort;
        return this;
    }
    ...
    public Port__2 withHostIP(String hostIP) {
        this.hostIP = hostIP;
        return this;
    }
    ...
    public Port__2 withHostPort(Integer hostPort) {
        this.hostPort = hostPort;
        return this;
    }
    ...
    public Port__2 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Port__2 withProtocol(String protocol) {
        this.protocol = protocol;
        return this;
    }
    ...
    public Port__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Port__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Port__2) == false) {
            return false;
        }
        Port__2 rhs = ((Port__2) other);
