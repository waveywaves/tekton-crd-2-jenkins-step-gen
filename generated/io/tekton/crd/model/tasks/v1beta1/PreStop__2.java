...
public class PreStop__2 {
    ...
    @Valid
    private TcpSocket__11 tcpSocket;
    @JsonIgnore
    @Valid
     ...
     */
    @JsonProperty("exec")
    public void setExec(Exec__11 exec) {
        this.exec = exec;
    }

    public PreStop__2 withExec(Exec__11 exec) {
        this.exec = exec;
        return this;
    }
     ...
     */
    @JsonProperty("httpGet")
    public void setHttpGet(HttpGet__11 httpGet) {
        this.httpGet = httpGet;
    }

    public PreStop__2 withHttpGet(HttpGet__11 httpGet) {
        this.httpGet = httpGet;
        return this;
    }
     ...
     */
    @JsonProperty("sleep")
    public void setSleep(Sleep__5 sleep) {
        this.sleep = sleep;
    }

    public PreStop__2 withSleep(Sleep__5 sleep) {
        this.sleep = sleep;
        return this;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public TcpSocket__11 getTcpSocket() {
        return tcpSocket;
    }
     ...
     */
    @JsonProperty("tcpSocket")
    public void setTcpSocket(TcpSocket__11 tcpSocket) {
        this.tcpSocket = tcpSocket;
    }

    public PreStop__2 withTcpSocket(TcpSocket__11 tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }
    ...
    public PreStop__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PreStop__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("exec");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PreStop__2) == false) {
            return false;
        }
        PreStop__2 rhs = ((PreStop__2) other);
