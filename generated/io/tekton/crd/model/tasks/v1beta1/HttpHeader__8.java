...
public class HttpHeader__8 {
    ...
    public HttpHeader__8 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__8 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__8 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__8 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__8) == false) {
            return false;
        }
        HttpHeader__8 rhs = ((HttpHeader__8) other);
