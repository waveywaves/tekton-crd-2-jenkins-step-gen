...
public class HttpHeader__13 {
    ...
    public HttpHeader__13 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__13 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__13 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__13 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__13) == false) {
            return false;
        }
        HttpHeader__13 rhs = ((HttpHeader__13) other);
