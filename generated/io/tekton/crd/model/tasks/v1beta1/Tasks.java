...
public class Tasks {
     ...
     */
    @JsonProperty("spec")
    @JsonPropertyDescription("Spec holds the desired state of the Task from the client")
    @Valid
    private Spec spec;
    @JsonIgnore
    @Valid
    ...
    public Tasks withApiVersion(String apiVersion) {
        this.apiVersion = apiVersion;
        return this;
    }
    ...
    public Tasks withMetadata(Metadata metadata) {
        this.metadata = metadata;
        return this;
    }
    ...
    public Tasks withSpec(Spec spec) {
        this.spec = spec;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tasks.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
