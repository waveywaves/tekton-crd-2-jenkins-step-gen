...
public class HttpHeader__4 {
    ...
    public HttpHeader__4 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpHeader__4 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public HttpHeader__4 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HttpHeader__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HttpHeader__4) == false) {
            return false;
        }
        HttpHeader__4 rhs = ((HttpHeader__4) other);
