...
public class EnvFrom__2 {
    ...
    @Valid
    private ConfigMapRef__2 configMapRef;
    /**
    ...
    @Valid
    private SecretRef__2 secretRef;
    @JsonIgnore
    @Valid
     ...
     */
    @JsonProperty("configMapRef")
    public ConfigMapRef__2 getConfigMapRef() {
        return configMapRef;
    }
     ...
     */
    @JsonProperty("configMapRef")
    public void setConfigMapRef(ConfigMapRef__2 configMapRef) {
        this.configMapRef = configMapRef;
    }

    public EnvFrom__2 withConfigMapRef(ConfigMapRef__2 configMapRef) {
        this.configMapRef = configMapRef;
        return this;
    }
    ...
    public EnvFrom__2 withPrefix(String prefix) {
        this.prefix = prefix;
        return this;
    }
     ...
     */
    @JsonProperty("secretRef")
    public SecretRef__2 getSecretRef() {
        return secretRef;
    }
     ...
     */
    @JsonProperty("secretRef")
    public void setSecretRef(SecretRef__2 secretRef) {
        this.secretRef = secretRef;
    }

    public EnvFrom__2 withSecretRef(SecretRef__2 secretRef) {
        this.secretRef = secretRef;
        return this;
    }
    ...
    public EnvFrom__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EnvFrom__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EnvFrom__2) == false) {
            return false;
        }
        EnvFrom__2 rhs = ((EnvFrom__2) other);
