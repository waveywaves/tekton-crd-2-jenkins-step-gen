...
public class Workspace__1 {
    ...
    public Workspace__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Workspace__1 withSubPath(String subPath) {
        this.subPath = subPath;
        return this;
    }
    ...
    public Workspace__1 withWorkspace(String workspace) {
        this.workspace = workspace;
        return this;
    }
    ...
    public Workspace__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Workspace__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Workspace__1) == false) {
            return false;
        }
        Workspace__1 rhs = ((Workspace__1) other);
