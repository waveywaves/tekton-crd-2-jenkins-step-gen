...
public class Output__1 {
    ...
    public Output__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Output__1 withResource(String resource) {
        this.resource = resource;
        return this;
    }
    ...
    public Output__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.resource == rhs.resource)||((this.resource!= null)&&this.resource.equals(rhs.resource))));
    }
